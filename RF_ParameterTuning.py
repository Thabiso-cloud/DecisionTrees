...
random_forrest_model = RandomForestClassifier(n_jobs=-1, max_features='sqrt')

feature_train, feature_test, target_train, target_test = train_test_split(image_features, image_targets, train_size=0.2)

param_grid = {
    "n_estimators": [10, 100, 500, 1000],
    "max_depth": [1, 5, 10, 15],
    "min_samples_leaf": [1, 2, 3, 4, 10, 15, 30, 50]
}

grid_search = GridSearchCV(estimator= random_forrest_model, param_grid=param_grid, cv=10)
